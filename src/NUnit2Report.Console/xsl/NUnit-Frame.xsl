...
-->
  <xsl:template name="all.packages">
    <html>
      ...
      <body>
        <h2>
          <a href="overview-summary.html"  id=":i18n:Home" target="classFrame">Home</a>
        </h2>
          ...
          <tr>
            <td nowrap="nowrap">
              <a target="classFrame" href="overview-summary.html">
                <xsl:value-of select="nunit2report:assemblie(@name)"/>
              </a>
            </td>
          </tr>
        </table>
            ...
            <tr valign="top">
              ...
              <td width="40%" height="9px">
                <xsl:if test="round($runCount2 * 200 div $testCount2 )!=0">
                  <span class="covered">
                    <xsl:attribute name="style">
                      width:<xsl:value-of select="round($runCount2 * 200 div $testCount2 )"/>px
                    </xsl:attribute>
                  </span>
                </xsl:if>
                <xsl:if test="round($errorCount2 * 200 div $testCount2 )!=0">
                  <span class="ignored">
                    <xsl:attribute name="style">
                      width:<xsl:value-of select="round($errorCount2 * 200 div $testCount2 )"/>px
                    </xsl:attribute>
                  </span>
                </xsl:if>
                <xsl:if test="round($failureCount2 * 200 div $testCount2 )!=0">
                  <span class="uncovered">
                    <xsl:attribute name="style">
                      width:<xsl:value-of select="round($failureCount2 * 200 div $testCount2 )"/>px
                    </xsl:attribute>
                  </span>
                </xsl:if>
              </td>
              <!--  ******************************************************* -->
              <td>
                <xsl:value-of select="$runCount2"/>
              </td>
              <td>
                <xsl:value-of select="$errorCount2"/>
              </td>
              <td>
                <xsl:value-of select="$failureCount2"/>
              </td>
              <td>
                <xsl:call-template name="display-time">
...
-->
  <xsl:template name="test-case">
    ...
    <html>
      <head>
        <title>
          Unit Test for class <xsl:value-of select="./@name"/>
        </title>
        <xsl:call-template name="create.stylesheet.link">
          <xsl:with-param name="package.name">
          ...
          <tr valign="top">
            ...
            <td width="40%" height="9px">
              <xsl:if test="round($runCount * 200 div $testCount )!=0">
                <span class="covered">
                  <xsl:attribute name="style">
                    width:<xsl:value-of select="round($runCount * 200 div $testCount )"/>px
                  </xsl:attribute>
                </span>
              </xsl:if>
              <xsl:if test="round($errorCount * 200 div $testCount )!=0">
                <span class="ignored">
                  <xsl:attribute name="style">
                    width:<xsl:value-of select="round($errorCount * 200 div $testCount )"/>px
                  </xsl:attribute>
                </span>
              </xsl:if>
              <xsl:if test="round($failureCount * 200 div $testCount )!=0">
                <span class="uncovered">
                  <xsl:attribute name="style">
                    width:<xsl:value-of select="round($failureCount * 200 div $testCount )"/>px
                  </xsl:attribute>
                </span>
              </xsl:if>
            </td>
